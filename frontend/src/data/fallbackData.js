export const FALLBACK_PROFILE = {
  ...
  email: "vraj92063@gmail.com",
  experience: "Fresher",
  tagline: "Cinematic stories. Powerful visuals. Thoughtful motion.",
  bio: "I’m Vimal Raj K, a passionate video editor and motion graphics designer from Coimbatore. I enjoy turning raw footage into engaging visual stories through cinematic editing, creative transitions and motion design.",
  primary_skills: [
...
export const FALLBACK_PROJECTS = [
  {
    ...
    creative_approach: "Emphasized high contrast, deep shadows, and rich teal & orange color splits. The editing rhythm follows low ambient synth hums, pacing transitions with light leaks and lens flares.",
    editing_techniques: "L-cuts & J-cuts for seamless audio pacing, keyframe motion tracking, speed ramping, custom teal/orange LUT color grade, noise reduction, and optical flares.",
    ...
    software_list: ["Adobe Premiere Pro", "Adobe After Effects", "Adobe Photoshop"],
    year: "2026",
  ...
  },
  {
    ...
    full_description: "Designed for short-form social campaigns, Velocity combines rapid-fire editing, kinetic text callouts, sound design impacts, and seamless whip zooms to keep viewers hooked from frame 1.",
    ...
    software_list: ["Adobe Premiere Pro", "Adobe After Effects"],
    year: "2026",
  ...
  },
  {
    ...
    editing_techniques: "After Effects expressions (wiggle, loopIn, index), shape layer trim paths, custom chromatic aberration glitch effects, camera shake script, vector element animation.",
    ...
    software_list: ["Adobe After Effects", "Adobe Illustrator"],
    year: "2026",
  ...
  },
  {
    ...
    software_list: ["Adobe Premiere Pro", "Adobe Photoshop"],
    year: "2025",
  ...
  },
  {
    ...
    software_list: ["Adobe After Effects", "Adobe Illustrator", "Adobe Photoshop"],
    year: "2026",
